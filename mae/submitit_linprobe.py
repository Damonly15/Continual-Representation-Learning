...
#python submitit_linprobe.py --cls_token --plotting_dir /cluster/home/dammeier/CRL/plotting --finetune /cluster/home/dammeier/CRL/checkpoints/mae_pretrain_task0_vit_base.pth --data_path /cluster/scratch/dammeier/imagenet_task0/ --nb_classes 250
...
def main():
    ...
    executor.update_parameters(name="linprob")
